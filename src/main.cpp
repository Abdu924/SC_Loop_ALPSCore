...
tuple<string, int> handle_command_line(po::variables_map vm, po::options_description desc) {
     ...
     return tuple<string, int>(input_file, computation_type);
}
...
int main(int argc, char** argv) {
     ...
     tie(tmp_file_name, computation_type) = handle_command_line(vm, desc);
