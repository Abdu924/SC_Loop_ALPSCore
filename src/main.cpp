...
class MyHybridization:public alps::mcbase {
public:
     //constructor
     MyHybridization(const alps::params &parms, int crank);
     static void define_parameters(alps::params &parms);
     virtual ~MyHybridization(){}
};
     
void MyHybridization::define_parameters(alps::params &parameters) {
...
typedef alps::mcmpiadapter<MyHybridization> sim_type;
#else
typedef MyHybridization sim_type;
#endif
...
int main(int argc, char** argv) {
     ...
     // alps::parameters_type<MyHybridization>::type parameters(argc, (const char**)argv, "/parameters");
     // MyHybridization::define_parameters(parameters);
