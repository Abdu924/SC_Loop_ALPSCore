...
void DMFTModel::dump_bubble_hdf5() {
     if (world_rank_ == 0) {
...
void DMFTModel::compute_local_bubble() {
...
std::vector<Eigen::MatrixXcd> DMFTModel::get_greens_function(
...
void DMFTModel::compute_lattice_bubble() {
...
const std::string DMFTModel::bubble_hdf5_root = "c_bubble";
